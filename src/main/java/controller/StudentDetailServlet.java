...
public class StudentDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userPath.equals("/student/index")) {
            ...
            PetitionForm p = new PetitionForm(pid, student, 1, "waiting", requestOption, requestMessage, requestReason, null,null,null,null);
            ...
            ChangeSectionForm c = new ChangeSectionForm(pid, student, 1, "waiting", requestOption, courseNumber, sectionNumber, requestMessage, null,null);
